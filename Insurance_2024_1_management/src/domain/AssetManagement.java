...
public class AssetManagement {
	...
	public String getAssetManagementStatus() {
		return assetManagementStatus;
	}

	public int getAssetManagementID() {
		return assetManagementID;
	}

	public void setAssetManagementID(int assetManagementID) {
		this.assetManagementID = assetManagementID;
	}

	public void setAssetManagementStatus(String assetManagementStatus) {
	...
	public String getMarketInfomation() {
		return marketInfomation;
	}

	public void setMarketInfomation(String marketInfomation) {
		this.marketInfomation = marketInfomation;
	}
	...
	public String getRickPlan() {
		return rickPlan;
	}

	public void setRickPlan(String rickPlan) {
		this.rickPlan = rickPlan;
	}
	...
	public BusinessPlan getM_BusinessPlan() {
		return m_BusinessPlan;
	}

	public void setM_BusinessPlan(BusinessPlan m_BusinessPlan) {
		this.m_BusinessPlan = m_BusinessPlan;
	}
