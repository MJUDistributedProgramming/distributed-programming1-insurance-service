...
public class Employee {
	...
	// 경영전략을 수립한다.
	public String createBusinessStraegy(BusinessStraegy businessStraegy, String result) throws DuplicateIDException {
	...
	// set & get
	public void setAssetManagementListImpl(AssetManagementList assetManagementListImpl) {
		this.assetManagementListImpl = assetManagementListImpl;
	}

	public void setBusinessStraegyListImpl(BusinessStraegyList businessStraegyListImpl) {
		this.businessStraegyListImpl = businessStraegyListImpl;
	}

	public void setDepositClosureDetailListImpl(DepositClosureDetailList depositClosureDetailListImpl) {
		this.depositClosureDetailListImpl = depositClosureDetailListImpl;
	}

	public void setLoanApplicationListImpl(LoanApplicationList loanApplicationListImpl) {
		this.loanApplicationListImpl = loanApplicationListImpl;
	}

	public void setLoanListImpl(LoanList loanListImpl) {
		this.loanListImpl = loanListImpl;
	}

	public void setRegulationListImpl(RegulationList regulationListImpl) {
		this.regulationListImpl = regulationListImpl;
	}
	// set & get
	public Performance getM_Performance() {
		return m_Performance;
	}

	public void setM_Performance(Performance m_Performance) {
		this.m_Performance = m_Performance;
	}

	public Assignment getM_Assignment() {
		return m_Assignment;
	}

	public void setM_Assignment(Assignment m_Assignment) {
